...
public class KafkaConsumerConfig {
    @Bean
    public ConsumerFactory<String, OperationBootCoinModel> userConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OperationBootCoinModel> userKafkaListenerFactory() {
